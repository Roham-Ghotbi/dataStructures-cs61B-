...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            currNode = new GraphNode("noName", Long.parseLong(attributes.getValue("id")),
...
//            System.out.println("Beginning a way...");
            currWay = new GraphWay("NoName", Long.parseLong(attributes.getValue("id")));
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            currWay.pathNodes.add(Long.parseLong(attributes.getValue("ref")));
...
//                System.out.println("Highway type: " + v);
                ...
                currWay.valid = ALLOWED_HIGHWAY_TYPES.contains(v);
...
//            System.out.println("Finishing a way...");
            if (currWay.valid) {
                for (int i = 0; i < currWay.pathNodes.size() - 1; i++) {
                    Long id = currWay.pathNodes.get(i);
                    Long next = currWay.pathNodes.get(i + 1);
                    g.addEdge(g.nodes.get(id), g.nodes.get(next));
                }
            }
        }
    }
